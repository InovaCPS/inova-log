...
name = "inova-log"
version = "0.0.1"
summary = "Centro Paula Souza - Inova - Log Service Module"
description = "Log service module created to integrate with a set of microservices of the CPS Inova projects."
...
def initialize(project):  # initialize dependencies, project version, properties, licence, etc.
    ...
    project.set_property('distutils_setup_keywords', ['cps', 'inova', 'log'])
